...
SMODS.Consumable { -- Plant Food
    ...
    can_use = function(self, card)
        ...
        if joker.config.center.original_mod
            and joker.config.center.original_mod.id == 'PVZJOKERS'
            and joker.config.center.can_use_plantfood
            and joker.config.center:can_use_plantfood(joker) then
            return true
        end
    ...
    use = function(self, card)
        ...
        if joker.config.center.on_plant_food_use then
            joker.config.center:on_plant_food_use(joker)
        end
